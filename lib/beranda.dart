                ...
                child: new ListView(
                    ...
                    new Container(
                      ...
                      child: RaisedButton.icon(
                        ...
                        onPressed: () {},
                        icon: Image.asset("asset/tipstrick.png", height: 35, width: 35,),
                        label: Text("Tips & Trik Pengolahan Sampah", style: TextStyle(fontSize: 15),),
                      ),
                    ),
                      new Container(
                        padding: EdgeInsets.only(left: 25.0, right: 25.0, top: 30.0),
                        ...
                        child: RaisedButton.icon(
                          ...
                          icon: Image.asset("asset/setorsampah.png", height: 35, width: 35,),
                          label: Text("Setor Sampah", style: TextStyle(fontSize: 15),),
                        ),
                      ),
                      new Container(
                        padding: EdgeInsets.only(left: 25.0, right: 25.0, top: 30.0),
                        ...
                        child: RaisedButton.icon(
                          ...
                          color: Color(0xff84c263),
                          onPressed: () {},
                          icon: Image.asset("asset/riwayat.png", height: 35, width: 35,),
                          label: Text("Riwayat Setoran", style: TextStyle(fontSize: 15),),
                        ),
                      ),
                  new Container(
                    color: Colors.white,
